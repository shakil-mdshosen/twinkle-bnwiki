 ...
 * |               সম্পাদনার পূর্বে দয়া করে [[WT:TW]]-এ আলোচনা করুন।           |
 * +-------------------------------------------------------------------------+
 *
 * গিটহাব থেকে আমদানি করা হয়েছে [https://github.com/wikimedia-gadgets/twinkle]।
 * সমস্ত পরিবর্তনগুলি সংগ্রহস্থলে করা উচিত, অন্যথায় সেগুলি হারিয়ে যাবে।
 *
 * ----------
 *
  * এটি AzaToth-এর টুইংকল, একটি জনপ্রিয় স্ক্রিপ্ট যা উইকিপিডিয়া mw.util.jsMessage রক্ষণাবেক্ষণে ব্যবহারকারী, প্রশাসক
 * ও অন্যান্য সবাইকে সাহায্য করে। মূল প্রকল্পটি এখানে পাওয়া যাবে:[https://github.com/azatoth/twinkle] 
 * এই সংস্করণটি বাংলা উইকিপিডিয়ার [http://bn.wikipedia.org] উপযোগী করে সম্পাদিত।
 * আরও তথ্যের জন্য [[WP:TW]] ভ্রমণ করুন।
...
Twinkle.defaultConfig = {
	...
	prodReasonDefault: '',
	logProdPages: false,
	prodLogPageName: 'দ্রুত অপসারণ লগ',
	...
	speedyLogPageName: 'দ্রুত অপসারণ লগ',
	...
	xfdLogPageName: 'অপসারণ প্রস্তাবনা লগ',
	...
	summaryAd: ' ([[WP:টুইংকল|টুইং]])',
	deletionSummaryAd: ' ([[WP:টুইংকল|টুইং]])',
	protectionSummaryAd: ' ([[WP:টুইংকল|টুইং]])',
	...
	talkbackHeading: mw.config.get('wgUserName') + ' আপনাকে নতুন বার্তা পাঠিয়েছেন',
...
switch (mw.config.get('skin')) {
	...
	case 'vector-2022':
		...
		Twinkle.defaultConfig.portletName = 'টুইংকল';
...
Twinkle.addPortlet = function(navigation, id, text, type, nextnodeid) {
	...
	if (skin === 'vector' || skin === 'vector-2022') {
		ul.className = 'menu vector-menu-content-list mm-menu';
...
$.ajax({
	...
	.fail(function () {
		mw.notify('আপনার টুইংকল পছন্দসমূহ লোড করা যায়নি, পূর্বনির্ধারিত পছন্দসমূহ ব্যবহার করা হল');
	})
	.done(function (optionsText) {
		...
		try {
			...
			mw.notify('আপনার টুইংকল পছন্দসমূহ পার্স করা যায়নি', {type: 'error'});
		}
	})
	.always(function () {
		$(Twinkle.load);
...
Twinkle.load = function () {
	...
	if (usingSkinWithDropDownMenu) {
		Twinkle.addPortletLink(mw.util.getUrl('উইকিপিডিয়া:টুইংকল/পছন্দসমূহ'), 'পছন্দসমূহ', 'tw-config', 'টুইংকল পছন্দসমূহের পাতা খুলুন');
	}
};
...
Twinkle.makeFindSourcesDiv = function makeSourcesDiv(divID) {
	...
	if (!Twinkle.findSources) {
		...
		parser.beginRender('({{উৎস খুঁজুন|' + Morebits.pageNameNorm + '}})', 'WP:AFD').then(function() {
