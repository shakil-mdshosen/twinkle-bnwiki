 ...
 ****************************************
 * Mode of invocation:     Tab ("অপসারণ প্রস্তাবনা")
...
Twinkle.xfd = function twinklexfd() {
	...
	var tooltip = 'একটি অপসারণ প্রস্তাবনা শুরু করুন';
	if (mw.config.get('wgIsRedirect')) {
		tooltip += ' অথবা এটিকে অন্যত্র পুনর্নির্দেশ করুন';
	} else {
		switch (mw.config.get('wgNamespaceNumber')) {
			case 0:
				tooltip += ' অথবা এই নিবন্ধটি স্থানান্তর করুন';
				break;
			case 10:
				tooltip += ' অথবা এই টেমপ্লেটটি একীভূত করুন';
				break;
			case 828:
			...
			case 6:
				...
				break;
			case 14:
				tooltip += ', এই বিষয়শ্রেণীটি একীভূত অথবা পুনঃনামকরণ';
				break;
			default:
				tooltip += ' এই পাতা';
				break;
	...
	Twinkle.addPortletLink(Twinkle.xfd.callback, 'অপসারণ প্রস্তাবনা', 'tw-xfd', tooltip);
};
...
Twinkle.xfd.printRationale = function twinklexfdPrintRationale() {
	if (Twinkle.xfd.currentRationale) {
		Morebits.status.printUserText(Twinkle.xfd.currentRationale, 'আপনার অপসারণের যুক্তি নিচে দেওয়া হয়েছে, আপনি যদি আবার চেষ্টা করতে চান তাহলে আপনি একটি নতুন অপসারণ ডায়ালগে অনুলিপি ও প্রতিলিপি করতে পারেন:');
...
Twinkle.xfd.callback = function twinklexfdCallback() {
	...
	Window.setTitle('একটি অপসারণ প্রস্তাবনা শুরু করুন (XFD)');
	Window.setScriptName('টুইংকল');
	Window.addFooterLink('অপসারণ আলোচনা প্রসঙ্গ', 'WP:XFD');
	Window.addFooterLink('অপসারণ প্রস্তাবনার পছন্দ', 'WP:TW/PREF#xfd');
	Window.addFooterLink('টুইংকল সাহায্য', 'WP:TW/DOC#xfd');
	Window.addFooterLink('মতামত দিন', 'WT:TW');

	var form = new Morebits.quickForm(Twinkle.xfd.callback.evaluate);
	var categories = form.append({
		type: 'select',
		name: 'venue',
		label: 'অপসারণ আলোচনার স্থান:',
		tooltip: 'সক্ষম করা হলে একটি নামস্থানের ভিত্তিতে পূর্বনির্ধারিত নির্বাচন তৈরি হবে। এই পূর্বনির্ধারিতটি সবচেয়ে বেশি গণ্য হওয়া উচিত।',
	...
	categories.append({
		type: 'option',
		label: 'RfD (পুনর্নির্দেশ অপসারণের প্রস্তাবনা)',
	...
	form.append({
		...
		list: [
			{
				label: 'পাতা তৈরিকারীকে সম্ভব হলে জানান',
				value: 'notify',
				name: 'notifycreator',
	...
	switch (venue) {
		...
		case 'rm':
			if (namespace === 14) { // category
				text = 'বিষয়শ্রেণী পরিবর্তনের জন্য দয়া করে CfD বা CfDS ব্যবহার করুন।';
...
Twinkle.xfd.callback.change_category = function twinklexfdCallbackChangeCategory(e) {
	...
	var appendReasonBox = function twinklexfdAppendReasonBox() {
		work_area.append({
			...
			label: 'কারণ:',
			value: oldreason,
			tooltip: 'আপনি কারণে উইকি মার্কআপ ব্যবহার করতে পারেন। টুইংকল স্বংয়ক্রিয়ভাবে আপনার স্বাক্ষর যোগ করবে।'
		});
	};
	...
	switch (value) {
		case 'afd':
			work_area = new Morebits.quickForm.element({
				type: 'field',
				label: 'নিবন্ধ অপসারণের প্রস্তাবনা',
				name: 'work_area'
			});
			...
			work_area.append({
				...
				list: [
					{
						label: 'অপসারণ ট্যাগকে &lt;noinclude&gt; দিয়ে আবৃত করুন',
						value: 'noinclude',
						name: 'noinclude',
			...
			work_area.append({
				type: 'select',
				name: 'xfdcat',
				label: 'অপসারণ প্রস্তাবনার বিষয় নির্বাচন করুন:',
				list: [
					{ type: 'option', label: 'অজানা', value: '?', selected: true },
					{ type: 'option', label: 'মিডিয়া ও সঙ্গীত', value: 'M' },
					{ type: 'option', label: 'সংস্থা, করপোরেশন, বা পণ্য', value: 'O' },
					{ type: 'option', label: 'জীবনী', value: 'B' },
					{ type: 'option', label: 'সামাজিক বিষয়', value: 'S' },
					{ type: 'option', label: 'ওয়েব বা ইন্টারনেট', value: 'W' },
					{ type: 'option', label: 'খেলাধুলা', value: 'G' },
					{ type: 'option', label: 'বিজ্ঞান ও প্রযুক্তি', value: 'T' },
					{ type: 'option', label: 'কথাসাহিত্য ও শিল্পকলা', value: 'F' },
					{ type: 'option', label: 'স্থান ও পরিবহন', value: 'P' },
					{ type: 'option', label: 'অনির্ণেয় বা শ্রেণিকরণযোগ্য নয় এমন বিষয়', value: 'I' },
					{ type: 'option', label: 'বিতর্ক এখনো শ্রেনিবিভক্ত করা হয়নি', value: 'U' }
				]
			});
			/***
			work_area.append({
...
Twinkle.xfd.callbacks = {
	...
	notifyUser: function(params, notifyTarget, noLog, actionName) {
		...
		if (targetNS === 3) {
			...
			if (usernameOrTarget === mw.config.get('wgUserName')) {
				Morebits.status.warn('আপনি (' + usernameOrTarget + ') এই পাতাটি তৈরি করেছেন; বিজ্ঞপ্তি পাঠানো এড়িয়ে যাওয়া হচ্ছে');
			...
			actionName = actionName || 'মূল অবদানকারীকে জানানো হচ্ছে (' + usernameOrTarget + ')';
		}
		...
		var venueNames = {
			afd: 'নিবন্ধ অপসারণের প্রস্তাবনা',
			tfd: 'টেমপ্লেট অপসারণের প্রস্তাবনা',
			mfd: 'অন্যান অপসারণ প্রস্তাবনা',
			cfd: 'বিষয়শ্রেণী অপসারণের প্রস্তাবনা',
			ffd: 'চিত্র অপসারণের প্রস্তাবনা',
			rfd: 'পুনর্নির্দেশ অপসারণের প্রস্তাবনা'
		};
		var editSummary = 'বিজ্ঞপ্তি: [[উইকিপিডিয়া:' + venueNames[params.venue] + ']]-এ [[:' +
			Morebits.pageNameNorm + ']] পাতাটি [[' + params.discussionpage + '|তালিকাভুক্ত]] করা হয়েছে।';
	...
	addToLog: function(params, initialContrib) {
		...
		usl.initialText =
			"এই সব [[WP:Afd|অপসারণ প্রস্তাবনার]] মনোনয়নের লগ যা [[WP:TW|টুইংকলের]] Xfd মডিউল ব্যবহার করে এই ব্যবহারকারী তৈরি করেছেন।\n\n" +
			'আপনি যদি আর এই লগ রাখতে না চান, তাহলে আপনি  [[উইকিপিডিয়া:টুইংকল/পছন্দসমূহ|পছন্দসমূহ প্যানেল]] ব্যবহার করে এটি বন্ধ করতে পারেন, এবং '+ '[[WP:CSD#U1|সিএসডি ব১]]-এর অধীনে এই পাতাটি দ্রুত অপসারণের জন্য মনোনয়ন করতে পারেন।' +
			(Morebits.userIsSysop ? '\n\nএই লগ টুইংকল ব্যবহার করে Xfd সংক্রান্ত মুছে ফেলা পাতা তালিকাভুক্ত করে না।' : '');

		var editsummary =  'অপসারণ প্রস্তাবনার লগ তালিকাভুক্ত করা হচ্ছে; [[:' + Morebits.pageNameNorm + ']]।';
		...
		switch (params.venue) {
			...
			case 'mfd':
				if (params.notifyuserspace && params.userspaceOwner && params.userspaceOwner !== initialContrib) {
					appendText += '; {{user|1=' + params.userspaceOwner + '}} -কে জানানো হয়েছে';
				}
				break;
			case 'cfd':
		...
		appendText += ' ~~~~~';
		if (params.reason) {
			appendText += "\n#* '''কারণ''': " + Morebits.string.formatReasonForLog(params.reason);
		}
	...
	afd: {
		main: function(apiobj) {
			...
			if (titles.length <= 0) {
				...
				for (var i = 0; i < titles.length; ++i) {
					...
					if (title === 'উইকিপিডিয়া:নিবন্ধ অপসারণের প্রস্তাবনা/' + Morebits.pageNameNorm) {
						number = Math.max(number, 1);
						continue;
					}

					var order_re = new RegExp('^' +
						Morebits.string.escapeRegExp('উইকিপিডিয়া:নিবন্ধ অপসারণের প্রস্তাবনা/' + Morebits.pageNameNorm) +
						'\\s*\\(\\s*(\\d+)(?:(?:th|nd|rd|st) nom(?:ination)?)?\\s*\\)\\s*$');
					var match = order_re.exec(title);

					// No match; A non-good value or the match is an unrealistically high number. Avoid false positives such as Wikipedia:Articles for deletion/The Basement (2014), by ignoring matches greater than 100
				...
				apiobj.params.numbering = number > 0 ? ' (' + apiobj.params.number + ' মনোনয়ন)' : '';
			}
			apiobj.params.discussionpage = 'উইকিপিডিয়া:নিবন্ধ অপসারণের প্রস্তাবনা/' + Morebits.pageNameNorm + apiobj.params.numbering;

			Morebits.status.info('পরবর্তী আলোচনার পাতা', '[[' + apiobj.params.discussionpage + ']]');
			...
			// Tagging article
			var wikipedia_page = new Morebits.wiki.page(mw.config.get('wgPageName'), 'পাতায় অপসারণ প্রস্তাবনার ট্যাগ যুক্ত করা হচ্ছে');
		...
		taggingArticle: function(pageobj) {
			...
			if (text !== textNoAfd) {
				if (confirm('এই নিবন্ধে একটি অপসারণ প্রস্তাবনা ট্যাগ পাওয়া গেছে। সম্ভবত আপনার আগেই কেউ প্রস্তাব দিয়েছে।  \nবর্তমান ট্যাগকে প্রতিস্থাপন করতে Ok চাপুন (না করার পরামর্শ দেওয়া হচ্ছে), অথবা প্রস্তাবনা দেওয়া এড়িয়ে যেতে Cancel চাপুন।')) {
					text = textNoAfd;
				} else {
			...
			var wikipedia_page = new Morebits.wiki.page(params.discussionpage, 'নিবন্ধ অপসারণ প্রস্তাবনার পাতা তৈরি করা হচ্ছে');
			wikipedia_page.setCallbackParameters(params);
			wikipedia_page.load(Twinkle.xfd.callbacks.afd.discussionPage);

			// Today's list
			var date = new Morebits.date(pageobj.getLoadTime());
			wikipedia_page = new Morebits.wiki.page('উইকিপিডিয়া:নিবন্ধ অপসারণের প্রস্তাবনা/২০২২' + ' ' +
				date.format('MMMM', 'utc'), "এই মাসের তালিকায় আলোচনা যোগ করা হচ্ছে");
			...
			// Remove some tags that should always be removed on AfD.
				...
				if (text !== textNoSd && confirm('এই পাতায় একটি দ্রুত অপসারণ ট্যাগ পাওয়া গেছে। এটি অপসারণ করবেন?')) {
					text = textNoSd;
				}
				...
				pageobj.setEditSummary('অপসারণের জন্য মনোনীত করা হয়েছে; দেখুন [[:' + params.discussionpage + ']]।');
		...
		discussionPage: function(pageobj) {
			...
			pageobj.setEditSummary('[[:' + Morebits.pageNameNorm + ']] -এর জন্য আলোচনা পাতা তৈরি করা হয়েছে।');
		...
		todaysList: function(pageobj) {
			...
			if (!pageobj.exists()) {
				...
				text = old_text.replace(/(<!-- নতুন ভুক্তি নিচের তালিকার সবার উপরে যুক্ত করুন -->\n+)/, '$1' + added_data);
				if (text === old_text) {
			...
			pageobj.setPageText(text);
			pageobj.setEditSummary('[[:' + params.discussionpage + ']] যোগ করা হয়েছে।');
			pageobj.setChangeTags(Twinkle.changeTags);
	...
	tfd: {
		...
		taggingTemplate: function(pageobj) {
			...
			if (pageobj.canEdit() && ['wikitext', 'sanitized-css'].indexOf(pageobj.getContentModel()) !== -1) {
				...
				pageobj.setEditSummary('অপসারণের জন্য মনোনয়ন করা হয়েছে; দেখুন [[:' + params.discussionpage + ']].');
				pageobj.setChangeTags(Twinkle.changeTags);
				pageobj.setWatchlist(Twinkle.getPref('xfdWatchPage'));
				if (params.scribunto) {
	...
	ffd: {
		...
		todaysList: function(pageobj) {
			...
			pageobj.setEditSummary('[[:' + Morebits.pageNameNorm + ']] যোগ করা হয়েছে।');
			pageobj.setChangeTags(Twinkle.changeTags);
			pageobj.setWatchlist(Twinkle.getPref('xfdWatchDiscussion'));
			pageobj.setCreateOption('recreate');
			pageobj.save(function() {
	...
	switch (params.venue) {
		...
		case 'afd': // AFD
			query = {
				action: 'query',
				list: 'allpages',
				apprefix: 'নিবন্ধ অপসারণের প্রস্তাবনা/' + Morebits.pageNameNorm,
				apnamespace: 4,
				apfilterredir: 'nonredirects',
				aplimit: 'max', // 500 is max for normal users, 5000 for bots and sysops
				format: 'json'
			};
			wikipedia_api = new Morebits.wiki.api('নিবন্ধটিতে অপসারণ ট্যাগ যুক্ত করা হচ্ছে', query, Twinkle.xfd.callbacks.afd.main);
			wikipedia_api.params = params;
			wikipedia_api.post();
			break;
